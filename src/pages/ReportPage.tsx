...
import { Calendar, Search, Trash2, Download, ExternalLink, MapPin, ChevronLeft, ChevronRight, Check, BarChart2, Filter, Activity, Users } from 'lucide-react';
...
export const ReportPage: React.FC<ReportPageProps> = ({
  ...
  return (
    <div className="h-screen flex flex-col overflow-hidden bg-slate-50 p-6">
      {/* Search Input Box Frame */}
      <div className="w-full bg-white rounded-2xl border border-slate-100 shadow-sm p-6 space-y-4 shrink-0">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 text-xs font-sans">
          {/* Row item: From Date */}
